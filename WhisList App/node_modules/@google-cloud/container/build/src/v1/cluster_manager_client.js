...
class ClusterManagerClient {
    ...
    initialize() {
        ...
        this.clusterManagerStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // tslint:disable-next-line no-any
                this._protos.google.container.v1.ClusterManager, this._opts);
        ...
        for (const methodName of clusterManagerStubMethods) {
            const innerCallPromise = this.clusterManagerStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listUsableSubnetworksStream(request, options) {
        ...
        this.initialize();
        return this._descriptors.page.listUsableSubnetworks.createStream(this._innerApiCalls.listUsableSubnetworks, request, callSettings);
    }
    /**
